...
DATE_SOURCES = [
    ("28-Jun", "SSA Simpanan mentah 28 Juni 2026.csv"),
    ("29-Jun", "SSA Simpanan mentah 29 Juni 2026 (2).csv"),
    ("30-Jun", "SSA Simpanan MENTAH 30 Juni 2026 (1).csv"),
]
...
def main() -> None:
    ...
    print("=" * 70)
    print("Update CSV mikro 28 - 30 Juni 2026")
    print("=" * 70)

    # Process June 28 to 30
