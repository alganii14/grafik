...
DATE_SOURCES = [
    ("17-Jun", "SSA Simpanan mentah 17 Juni 2026.csv"),
    ("18-Jun", "SSA Simpanan_data 18 JUNI 2026.csv"),
    ("19-Jun", "SSA Simpanan 19 Juni 2026.csv"),
    ("20-Jun", "SSA Simpanan 20 Juni 2026.csv"),
]
...
def main() -> None:
    ...
    print("=" * 70)
    print("Update CSV mikro 17 - 20 Juni 2026")
    print("=" * 70)
