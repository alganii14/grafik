...
DATE_SOURCES = [
    ("09-Jul", "SSA Simpanan 9 Juli 2026.csv"),
    ("10-Jul", "SSA Simpanan 10 juli 2026.csv"),
    ("11-Jul", "SSA Simpanan 11 Juli 2026.csv"),
]
...
def main() -> None:
    ...
    print("=" * 70)
    print("Update CSV mikro 9 - 11 Juli 2026")
    print("=" * 70)

    # Process July 9 to 11
