...
DATE_SOURCES = [
    ("22-Jun", "SSA Simpanan 22 Juni 2026.csv"),
    ("23-Jun", "SSA Simpanan 23 Juni 2026.csv"),
    ("24-Jun", "SSA Simpanan mentah 24 Juni.csv"),
    ("25-Jun", "SSA Simpanan mentah 25 Juni 2026.csv"),
    ("26-Jun", "SSA Simpanan Mentah 26 Juni 2026.csv"),
    ("27-Jun", "SSA Simpanan mentah 27 Juni 2026.csv"),
]
...
def main() -> None:
    ...
    print("=" * 70)
    print("Update CSV mikro 22 - 27 Juni 2026")
    print("=" * 70)

    # Process June 17 to 20
