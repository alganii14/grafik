...
for folder in folders:
    ...
    dst = os.path.join(base_dir, folder, "update_13_agustus.py")
    ...
    content = content.replace('28 - 30 Juni', '13 Agustus')
    content = content.replace('# Process June 28 to 30', '# Process August 13')
