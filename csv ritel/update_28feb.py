...
def update_csv(filename, data, data_type, date_label):
    """Update CSV file with new date row"""
...
if __name__ == "__main__":
    print("=" * 60)
    print("Updating CSV RITEL files with 28 Feb data...")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("Done! CSV RITEL updated for 28 Feb.")
    print("=" * 60)
